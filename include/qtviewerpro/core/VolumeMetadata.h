...
/**
 * @brief Stores dimensions and voxel spacing for a 3D volume.
 *
 * VolumeMetadata is a lightweight container for volume shape and spacing
 * information. It does not own voxel data.
 */
class VolumeMetadata
{
public:
  /**
   * @brief Creates empty metadata with zero dimensions and unit spacing.
   */
  VolumeMetadata() = default;

  /**
   * @brief Creates metadata with dimensions and spacing.
   ...
   */
  VolumeMetadata(std::size_t width, std::size_t height, std::size_t depth, float spacingX,
                 float spacingY, float spacingZ);
